...
HD_PWD='C:/Users/lucasp/Projects/AES128-FPGA/AES128-FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_io.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_io.tcl -notrace
