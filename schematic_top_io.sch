...
load port btnC input -pg 1 -lvl 0 -x 0 -y 1140
load port btnD input -pg 1 -lvl 0 -x 0 -y 1470
load port btnR input -pg 1 -lvl 0 -x 0 -y 1340
load port clk input -pg 1 -lvl 0 -x 0 -y 1070
load portBus an output [3:0] -attr @name an[3:0] -pg 1 -lvl 11 -x 2550 -y 1160
load portBus led output [15:0] -attr @name led[15:0] -pg 1 -lvl 11 -x 2550 -y 40
load portBus seg output [6:0] -attr @name seg[6:0] -pg 1 -lvl 11 -x 2550 -y 1440
load inst FSM_onehot_state_reg[0] FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 5 -x 820 -y 570
load inst FSM_onehot_state_reg[1] FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 7 -x 1320 -y 1010
load inst FSM_onehot_state_reg[2] FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 5 -x 820 -y 990
load inst an_OBUF[0]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1160
load inst an_OBUF[1]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1230
load inst an_OBUF[2]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1300
load inst an_OBUF[3]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1370
load inst btnC_IBUF_inst IBUF hdi_primitives -attr @cell(#000000) IBUF -pg 1 -lvl 2 -x 180 -y 1140
load inst btnD_IBUF_inst IBUF hdi_primitives -attr @cell(#000000) IBUF -pg 1 -lvl 5 -x 820 -y 1470
load inst btnR_IBUF_inst IBUF hdi_primitives -attr @cell(#000000) IBUF -pg 1 -lvl 2 -x 180 -y 1340
load inst clk_IBUF_BUFG_inst BUFG hdi_primitives -attr @cell(#000000) BUFG -pg 1 -lvl 2 -x 180 -y 1070
load inst clk_IBUF_inst IBUF hdi_primitives -attr @cell(#000000) IBUF -pg 1 -lvl 1 -x 40 -y 1070
load inst dbg_ff1_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 6 -x 1060 -y 1460
load inst dbg_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 8 -x 1780 -y 1380
load inst dbg_sync_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 7 -x 1320 -y 1450
load inst display_c display work:display:NOFILE -autohide -attr @cell(#000000) display -pinBusAttr an_OBUF @name an_OBUF[3:0] -pinBusAttr seg_OBUF @name seg_OBUF[3:0] -pg 1 -lvl 9 -x 2150 -y 1270
load inst encryption_aes_c aes_enc work:aes_enc:NOFILE -autohide -attr @cell(#000000) aes_enc -pinBusAttr led_OBUF @name led_OBUF[15:0] -pg 1 -lvl 8 -x 1780 -y 980
load inst led_OBUF[0]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 40
load inst led_OBUF[10]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 740
load inst led_OBUF[11]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 810
load inst led_OBUF[12]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 880
load inst led_OBUF[13]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 950
load inst led_OBUF[14]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1020
load inst led_OBUF[15]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1090
load inst led_OBUF[1]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 110
load inst led_OBUF[2]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 180
load inst led_OBUF[3]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 250
load inst led_OBUF[4]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 320
load inst led_OBUF[5]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 390
load inst led_OBUF[6]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 460
load inst led_OBUF[7]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 530
load inst led_OBUF[8]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 600
load inst led_OBUF[9]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 670
load inst reset_encryption_i_1 LUT2 hdi_primitives -attr @cell(#000000) LUT2 -pg 1 -lvl 6 -x 1060 -y 1250
load inst reset_encryption_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 7 -x 1320 -y 1250
load inst rst_ff1_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 3 -x 400 -y 1330
load inst rst_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 5 -x 820 -y 1290
load inst rst_sync_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 4 -x 560 -y 1320
load inst seg_OBUF[0]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1440
load inst seg_OBUF[1]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1510
load inst seg_OBUF[2]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1580
load inst seg_OBUF[3]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1650
load inst seg_OBUF[4]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1720
load inst seg_OBUF[5]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1790
load inst seg_OBUF[6]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 10 -x 2380 -y 1860
load inst start_encryption_i_1 LUT2 hdi_primitives -attr @cell(#000000) LUT2 -pg 1 -lvl 6 -x 1060 -y 820
load inst start_encryption_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 7 -x 1320 -y 770
load inst strt_ff1_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 3 -x 400 -y 1130
load inst strt_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 5 -x 820 -y 1140
load inst strt_sync_reg FDRE hdi_primitives -attr @cell(#000000) FDRE -pg 1 -lvl 4 -x 560 -y 1120
...
netloc FSM_onehot_state_reg_n_0_[0] 1 5 3 960 790 1180J 870 1600
load net FSM_onehot_state_reg_n_0_[1] -pin FSM_onehot_state_reg[1] Q -pin encryption_aes_c FSM_onehot_state_reg[2]_1
netloc FSM_onehot_state_reg_n_0_[1] 1 7 1 1480 1010n
...
netloc FSM_onehot_state_reg_n_0_[2] 1 5 3 1000 910 NJ 910 1500
load net aes_done -pin display_c aes_done -pin encryption_aes_c aes_done
netloc aes_done 1 8 1 2020 1070n
...
netbloc @led_OBUF 1 8 2 N 1090 2340
levelinfo -pg 1 0 40 180 400 560 820 1060 1320 1780 2150 2380 2550
pagesize -pg 1 -db -bbox -sgen -80 0 2660 1900
show
fullfit
#
